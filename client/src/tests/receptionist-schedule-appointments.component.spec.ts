...
it('should have doctorId and patientId as required fields', () => {
  expect(component.itemForm.controls['doctorId'].hasError('required')).toBeTrue();
  expect(component.itemForm.controls['patientId'].hasError('required')).toBeTrue();
});
});
